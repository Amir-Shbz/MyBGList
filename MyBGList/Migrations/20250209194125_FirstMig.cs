    ...
    public partial class FirstMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardGames_Domains", x => new { x.DomainId, x.BoardGameId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardGames_Mechanics", x => new { x.MechanicId, x.BoardGameId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardGames_Domains_BoardGameId",
                table: "BoardGames_Domains",
                column: "BoardGameId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardGames_Mechanics_BoardGameId",
